...
export declare class ManifestGenerate extends SfCommand<ManifestGenerateCommandResult> {
    ...
    static readonly flags: {
        ...
        'include-packages': import("@oclif/core/interfaces").OptionFlag<string[] | undefined, import("@oclif/core/interfaces").CustomOptions>;
        'from-org': import("@oclif/core/interfaces").OptionFlag<Org | undefined, import("@oclif/core/interfaces").CustomOptions>;
